...
\subsubsection{Possible extra functionality (if there is time)}
...
\subsubsection{Operators}
    ...
    \begin{figure}[h]
            \hspace{-1em}
            \begin{tabular}{p{3em} p{16.5em}}
                \textbf{Union: } & \\[-0.8em]
                $A \cup B$ &
                $\forall[x,y,z \in \mathbb{R} :: \min(A(x, y, z), B(x,y,z))]$ \\[1em]

                \textbf{Intersection: } & \\[-0.8em]
                $A \cap B$ &
                $\forall[x,y,z \in \mathbb{R} :: \max(A(x, y, z), B(x,y,z))]$ \\[1em]

                \textbf{Difference: } & \\[-0.8em]
                $A - B$ &
                $\forall[x,y,z \in \mathbb{R} :: \max(A(x, y, z), -B(x, y, z))]$ \\[1em]
            \end{tabular}
...
\subsubsection{Normalizing CSG trees}
    ...
    \begin{table}[h]
        \hspace{-0.8em}
        \begin{tabular}{p{0.01\textwidth} p{0.15\textwidth} p{0.01\textwidth} p{0.23\textwidth}}
